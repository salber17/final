...
(function (e) {
      ...
      e: for (var Q = 0, Z = _.length, ur = Z >>> 1; Q < ur; ) {
        ...
        if (0 > l(jl, z))
          St < Z && 0 > l(sr, jl)
            ? ((_[Q] = sr), (_[St] = z), (Q = St))
            : ((_[Q] = jl), (_[wt] = z), (Q = wt));
        else if (St < Z && 0 > l(sr, z)) (_[Q] = sr), (_[St] = z), (Q = St);
        else break e;
      }
    }
    return T;
  ...
  function E(_, T) {
    ...
    try {
      for (
        d(T), m = n(s);
        m !== null && (!(m.expirationTime > T) || (_ && !Le()));
      ...
      if (m !== null) var ur = !0;
        ...
        var wt = n(a);
        wt !== null && zl(v, wt.startTime - T), (ur = !1);
      }
      return ur;
    } finally {
      (m = null), (p = z), (w = !1);
      ...
      return (
        ...
        z > Q
          ? ((_.sortIndex = z),
            ...
            n(s) === null &&
              _ === n(a) &&
              (g ? (f(L), (L = -1)) : (g = !0), zl(v, z - Q)))
          : ((_.sortIndex = Z), t(s, _), S || w || ((S = !0), Tl(E))),
        _
      );
    }),
...
function vu(e) {
  if ((e = lr(e))) {
    if (typeof _o != "function") throw Error(y(280));
    var t = e.stateNode;
...
function Gs() {
  if (Zt) {
    var e = Zt,
      t = qt;
    if (((qt = Zt = null), vu(e), t)) for (e = 0; e < t.length; e++) vu(t[e]);
  }
}
function Xs(e, t) {
  return e(t);
...
function Lf(e, t, n, r, l, o, i, u, s) {
  (Rn = !1), ($r = null), Nf.apply(Pf, arguments);
}
...
function Lr(e) {
  ...
  for (var t = e.targetContainers; 0 < t.length; ) {
    ...
    } else return (t = lr(n)), t !== null && xi(t), (e.blockedOn = n), !1;
    t.shift();
  }
  return !0;
}
...
function Ei(e, t, n, r) {
  if (Hr) {
    var l = To(e, t, n, r);
    if (l === null) Gl(e, t, r, Wr, n), wu(e, r);
...
var Wr = null;
function To(e, t, n, r) {
  if (((Wr = null), (e = wi(r)), (e = Et(e)), e !== null))
...
function yd(e, t) {
  if (Bt)
    return e === "compositionend" || (!Pi && ha(e, t))
      ? ((e = da()), (Rr = Ci = nt = null), (Bt = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function Ru() {
  zn && (zn.detachEvent("onpropertychange", ya), (Hn = zn = null));
}
function ya(e) {
  if (e.propertyName === "value" && hl(Hn)) {
    var t = [];
    va(t, Hn, e, wi(e)), Zs(Sd, t);
  }
}
function xd(e, t, n) {
  e === "focusin"
    ? (Ru(), (zn = t), (Hn = n), zn.attachEvent("onpropertychange", ya))
    : e === "focusout" && Ru();
}
function Ed(e) {
  ...
  if (!e[yr]) {
    (e[yr] = !0),
      Is.forEach(function (n) {
        n !== "selectionchange" && (zd.has(n) || Yl(n, !1, e), Yl(n, !0, e));
      });
        ...
        for (var c = a, d; c !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              f !== null && ((v = $n(c, f)), v != null && g.push(Kn(c, v, d)))),
            R)
          )
            break;
          c = c.return;
      ...
      L &&
        (pa &&
          ...
          (Bt || L !== "onCompositionStart"
            ? L === "onCompositionEnd" && Bt && (P = da())
            : ((nt = h),
              (Ci = "value" in nt ? nt.value : nt.textContent),
              (Bt = !0))),
        (N = Qr(a, L)),
        0 < N.length &&
          ((L = new Eu(L, e, null, n, h)),
          m.push({
            event: L,
            listeners: N,
          }),
...
function U(e) {
  0 > Wt || ((e.current = Uo[Wt]), (Uo[Wt] = null), Wt--);
}
function D(e, t) {
  Wt++, (Uo[Wt] = e.current), (e.current = t);
}
var mt = {},
  ie = gt(mt),
  pe = gt(!1),
...
function Ra(e, t, n) {
  ...
  if (((t = t.childContextTypes), typeof r.getChildContext != "function"))
    return n;
  r = r.getChildContext();
  for (var l in r) if (!(l in t)) throw Error(y(108, xf(e) || "Unknown", l));
  return V({}, n, r);
}
function Gr(e) {
  return (
...
function yt() {
  if (!Jl && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), ta(Si, yt), l);
    } finally {
      (I = t), (Jl = !1);
    }
  }
...
var Qt = [],
  ...
  We = "";
function kt(e, t) {
  (Qt[Kt++] = Jr), (Qt[Kt++] = Xr), (Xr = e), (Jr = t);
}
function za(e, t, n) {
  (xe[Ee++] = He), (xe[Ee++] = We), (xe[Ee++] = Rt), (Rt = e);
  var r = He;
  e = We;
  var l = 32 - Me(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function Ti(e) {
  for (; e === Xr; )
    (Xr = Qt[--Kt]), (Qt[Kt] = null), (Jr = Qt[--Kt]), (Qt[Kt] = null);
  for (; e === Rt; )
    (Rt = xe[--Ee]),
      (xe[Ee] = null),
      (We = xe[--Ee]),
...
function Ho(e, t, n, r) {
  var l = e.stateNode;
  (l.props = n), (l.state = e.memoizedState), (l.refs = Da), Di(e);
  var o = t.contextType;
  typeof o == "object" && o !== null
    ? (l.context = Ne(o))
...
function Ua(e) {
  ...
  function h(f, c, d, v, E) {
    return c === null || c.tag !== 7
      ? ((c = Pt(d, f.mode, v, E)), (c.return = f), c)
      : ((c = l(c, d)), (c.return = f), c);
  }
  function m(f, c, d) {
  ...
  function S(f, c, d, v) {
    for (
      var E = null, N = null, P = c, L = (c = 0), W = null;
      P !== null && L < d.length;
      L++
    ) {
    ...
    if (L === d.length) return n(f, P), $ && kt(f, L), E;
    if (P === null) {
      for (; L < d.length; L++)
        (P = m(f, d[L], v)),
          P !== null &&
            ((c = o(P, c, L)), N === null ? (E = P) : (N.sibling = P), (N = P));
      return $ && kt(f, L), E;
    }
  ...
  function g(f, c, d, v) {
    ...
    for (
      var N = (E = null), P = c, L = (c = 0), W = null, M = d.next();
      P !== null && !M.done;
      L++, M = d.next()
    ) {
      P.index > L ? ((W = P), (P = null)) : (W = P.sibling);
    ...
    if (M.done) return n(f, P), $ && kt(f, L), E;
    if (P === null) {
      for (; !M.done; L++, M = d.next())
        (M = m(f, M.value, v)),
          M !== null &&
            ((c = o(M, c, L)), N === null ? (E = M) : (N.sibling = M), (N = M));
      return $ && kt(f, L), E;
    }
    for (P = r(f, P); !M.done; L++, M = d.next())
      (M = w(P, f, L, M.value, v)),
        M !== null &&
...
function Fi(e, t) {
  switch ((D(Xn, t), D(Gn, e), D(Be, or), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function tc(e, t, n) {
  return Tt & 21
    ? (Ie(n, t) || ((n = la()), (A.lanes |= n), (zt |= n), (e.baseState = !0)),
      t)
...
function Wd(e, t, n) {
  ...
  if (rc(e)) lc(t, l);
    ...
    (n = Oa(e, t, l, r)),
      n !== null && ((l = se()), Oe(n, e, r, l), oc(n, t, r));
  }
}
function rc(e) {
  var t = e.alternate;
  ...
  return (
    ...
    e !== null && !de
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Xe(e, t, l))
      : ($ && n && Ri(t), (t.flags |= 1), ue(e, t, r, l), t.child)
  );
}
  ...
  return (
    ...
    e !== null && !de
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Xe(e, t, l))
      : ($ && r && Ri(t), (t.flags |= 1), ue(e, t, n, l), t.child)
  );
}
function ts(e, t, n, r, l) {
  ...
  if ((en(t, l), t.stateNode === null))
    Or(e, t), Fa(t, n, r), Ho(t, n, r, l), (r = !0);
  else if (e === null) {
    var i = t.stateNode,
      u = t.memoizedProps;
    i.props = u;
...
function Ko(e, t, n, r, l, o) {
  cc(e, t);
  var i = (t.flags & 128) !== 0;
  if (!r && !i) return l && Bu(t, n, !1), Xe(e, t, o);
...
function ns(e, t, n, r, l) {
  return ln(), zi(l), (t.flags |= 256), ue(e, t, n, r), t.child;
}
var Yo = {
  dehydrated: null,
  treeContext: null,
...
function Jd(e, t, n, r, l, o, i) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = to(Error(y(422)))), xr(e, t, i, r))
      : t.memoizedState !== null
  ...
  if (l.data === "$!") {
    ...
    return (r = u), (o = Error(y(419))), (r = to(o, r, void 0)), xr(e, t, i, r);
  }
  if (((u = (i & e.childLanes) !== 0), de || u)) {
    ...
    return Zi(), (r = to(Error(y(421)))), xr(e, t, i, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
  ...
  switch ((Ti(t), t.tag)) {
    ...
    case 6:
      if (e && t.stateNode != null) vc(e, t, e.memoizedProps, r);
        ...
        if (((n = _t(Xn.current)), _t(Be.current), Sr(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[Ue] = t),
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || B.current & 1 ? J === 0 && (J = 3) : Zi())),
          t.updateQueue !== null && (t.flags |= 4),
          le(t),
          null);
    case 4:
      return (
        un(), Xo(e, t), e === null && Qn(t.stateNode.containerInfo), le(t), null
      );
    case 10:
...
function gc(e) {
  ...
  t !== null && ((e.alternate = null), gc(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Ue], delete t[Yn], delete t[Fo], delete t[Fd], delete t[Ud])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function kc(e, t, n) {
  for (var r = (e.mode & 1) !== 0; x !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && o !== null ? ((o.return = l), (x = o)) : us(e);
  }
}
function us(e) {
  for (; x !== null; ) {
...
function Oe(e, t, n, r) {
  if (50 < Dn) throw ((Dn = 0), (ti = null), Error(y(185)));
  nr(e, n, r),
    (!(O & 2) || e !== b) &&
      (e === b && (!(O & 2) && (kl |= n), J === 4 && tt(e, te)),
      me(e, r),
      n === 1 && O === 0 && !(t.mode & 1) && ((an = K() + 500), gl && yt()));
}
function me(e, t) {
...
function xc(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = il(e, r);
    ...
    O |= 2;
    var o = Cc();
    (b !== e || te !== t) && ((Ae = null), (an = K() + 500), Nt(e, t));
    do
      try {
        ip();
        break;
  ...
  if (t !== 0) {
    if (
      (t === 2 && ((l = Lo(e)), l !== 0 && ((r = l), (t = ni(e, l)))), t === 1)
    )
    ...
    if (t === 6) tt(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (tt(e, r), (r & 130023424) === r && ((t = Gi + 500 - K()), 10 < t))
          ) {
            if (Vr(e, 0) !== 0) break;
...
function il(e, t) {
  ...
  while (1);
  if ((Mi(), (O = n), (rl.current = r), Y !== null)) throw Error(y(261));
...
function up(e, t, n, r) {
  ...
  if (ll) throw ((ll = !1), (e = ei), (ei = null), e);
  return (
    ol & 1 && e.tag !== 0 && tn(),
    (o = e.pendingLanes),
    o & 1 ? (e === ti ? Dn++ : ((Dn = 0), (ti = e))) : (Dn = 0),
    yt(),
    null
  );
}
  ...
  if (rt !== null) {
    ...
    try {
      if (((_e.transition = null), (I = 16 > e ? 16 : e), rt === null))
        ...
        if (((e = rt), (rt = null), (ol = 0), O & 6)) throw Error(y(331));
        var l = O;
...
function sp(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    b === e &&
      (te & n) === n &&
      (J === 4 || (J === 3 && (te & 130023424) === te && 500 > K() - Gi)
        ? Nt(e, 0)
        : (Yi |= n)),
    me(e, t);
}
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            Ho(t, r, e, n),
            (t = Ko(null, t, r, !0, o, n)))
          : ((t.tag = 0), $ && o && Ri(t), ue(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
      ...
      e: {
        ...
        if (((r = i.element), o.isDehydrated))
          if (
            ...
            (l = sn(Error(y(423)), t)), (t = ns(e, t, r, n, l));
            break e;
          } else if (r !== l) {
            (l = sn(Error(y(424)), t)), (t = ns(e, t, r, n, l));
            break e;
          } else
            for (
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (ki(t, n | 1), me(t, K()), !(O & 6) && ((an = K() + 500), yt()));
      }
      break;
    case 13:
      jt(function () {
...
var hs = ao;
(so.createRoot = hs.createRoot), (so.hydrateRoot = hs.hydrateRoot);
/**
...
function xp(e, t, n) {
  ...
  Ep(o);
  let i = null;
  for (let u = 0; i == null && u < o.length; ++u) i = jp(o[u], Ip(l));
  return i;
}
function Mc(e, t, n, r) {
...
function Tp(e, t) {
  ...
  return (
    ...
    n
      .filter((l) => !ys(l))
      .reduce((l, o) => l + (Cp.test(o) ? _p : o === "" ? Pp : Lp), r)
  );
}
function zp(e, t) {
...
function Rl() {
  return pn() || G(!1), C.useContext(Ll).location;
}
function $c() {
  pn() || G(!1);
...
function ih(e, t, n) {
  ...
  if (l != null) {
    ...
    o >= 0 || G(!1), (r = r.slice(0, Math.min(r.length, o + 1)));
  }
...
function ui(e, t) {
  ...
  return (
    C.Children.forEach(e, (r, l) => {
      ...
      r.type !== ii && G(!1), !r.props.index || !r.props.children || G(!1);
      let i = {
                  ...
                  k.jsxs("div", {
                    ...
                    children: [
                      ...
                      k.jsx("p", {
                        ...
                        children:
                          (r === "structure" && i.structure.content) ||
                          (r === "surface" && i.geology.content) ||
                          i.overview.content,
                      }),
                      k.jsxs("div", {
                        style: {
                        ...
                        children: [
                          ...
                          k.jsx("a", {
                            className: "source",
                            href:
                              (r === "structure" && i.structure.source) ||
                              (r === "surface" && i.geology.source) ||
                              i.overview.source,
                            children: "Wikipedia",
                          }),
                          k.jsx("img", {
